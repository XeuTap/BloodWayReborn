...
function modifier_generic_tracking_projectile:PlayTrackingProjectile( info )
	...
	self.effect_cast = assert(loadfile("libraries/abilities/rubick_spell_steal_lua/rubick_spell_steal_lua_arcana"))(self, info.EffectName, PATTACH_ABSORIGIN, info.Source )
	ParticleManager:SetParticleControlEnt(
		self.effect_cast,
		0,
		info.Source,
