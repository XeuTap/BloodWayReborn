modifier_hunter_critical_hit = class ({})

function modifier_hunter_critical_hit:IsHidden()
	return true
end

function modifier_hunter_critical_hit:DeclareFunctions()
	local funcs = {
...
function modifier_hunter_critical_hit:OnCreated( _kv )
	self:OnRefresh( _kv )
end

function modifier_hunter_critical_hit:OnRefresh( _kv )
...
function modifier_hunter_critical_hit:GetModifierPreAttack_CriticalStrike( params )
	if IsServer() then
...
function modifier_hunter_critical_hit:OnAttackLanded( params )
	if IsServer() then
